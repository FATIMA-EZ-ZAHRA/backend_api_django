...
SECRET_KEY = 'django-insecure-(n)+4wgur+2-avd968=6hy=mp2fi!lx)a+a_1yo&3m*1ao3y4%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS=['localhost','emsi-django-backend.herokuapp.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'd5f5u82hf203pp', 
        'USER': 'kjnhlkbqjvrwyl', 
        'PASSWORD': '4746c2b03381bcdfed526d4afd440bd601b3b946594efa67b38574f13117f207',
